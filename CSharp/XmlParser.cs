...
namespace Monads
{
    ...
    {
        [Fact]
        public void parses_xml()
        {
            var parsed = XmlParser.Document.Parse(@"<body>
  <p>
    hello,<br/> <!--
      This is a comment
    --><i>world!</i>
            ...
            parsed.Root.Name.Should().Be("body");
            parsed.Root.Children
                .Should().ContainSingle()
                .Which.Should().BeOfType<Node>()
                .Which.ToString().Should().Be("<p>hello,<br/><i>world!</i></p>");
        }
    }
